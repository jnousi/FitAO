...
AngleFloat = confloat(ge=0.0, le=360.0)
FractionFloat = confloat(ge=0.0, le=1.0)
...
class Telescope(Parameters):
    samplingTime: NonNegativeFloat
    diameter: NonNegativeFloat
    obstructionRatio: NonNegativeFloat
    pupilDiameter: NonNegativeFloat
