...
class SoapyEnv(gym.Env):
    ...
    def _param_file_parser(self):
        ...
        self.science_params,self.wfs_params,self.delay\
        ...
        self.tel_params["obsDiam"] = self.tel_params["diam"]*self.tel_params["obstructionRatio"]

        if self.wfs_params["type"] == "pyrhr":
            print("\033[93m"+"Soapy doesnt support pyramid WFS. Use Compass or OOMAO instead!"+'\x1b[0m')
            return False
    ...
    def _param_file_gen(self):
        ...
        f.write("    GSPosition:  "+str([self.gs_params["xpos"],self.gs_params["ypos"]])+"\n")
        ...
        f.write("\nScience:\n")
        f.write("  0:\n")
        f.write("    position:  "+str([self.science_params["xpos"],self.science_params["ypos"]])+"\n")
        f.write("    FOV:  1.0\n")
